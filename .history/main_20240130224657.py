...
def create_peticion(idTask: str = Body(), rut: str = Body(),telefono:str = Body(), sucursal:str = Body() , horario:int = Body(), correo:str = Body(), comentario: str = Body())->dict:
    ...
    response = requests.post("http://192.168.10.30/neoapi/webservice.asmx/ExecuteTask06?idTask=04&param1=123456789-k&param2=1234567890&param3=1&param4=1&param5=egonzalez@gmail.com&param6=prueba")

...
def create_peticion(idTask: str = Body(), rut: str = Body(),telefono:str = Body(), sucursal:str = Body() , horario:int = Body(), correo:str = Body(), comentario: str = Body())->dict:
    ...
    response = requests.get(f"http://192.168.10.30/neoapi/webservice.asmx/ExecuteTask06?idTask={idTask}&param1={rut}&param2={telefono}&param3={sucursal}&param4={horario}&param5={correo}g&param6={comentario}")
